  ...
  return (
    <>
      ...
      <div className="max-w-screen-xl mt-24 xl:px-16 mx-auto" id="about">
        <div className="md:flex px-4 sm:px-8 lg:px-16 gap-8 py-6 sm:py-16">
          <div className=" flex flex-col justify-center items-center md:items-start mb-6">
            <h1 className="text-3xl lg:text-4xl xl:text-5xl font-medium text-black-600 leading-normal text-center md:text-left">
          ...
          <div className="flex w-full">
            <img src="/hero.png" alt="Hero image" className="object-cover" />
          </div>
        </div>
      </div>
    </>
